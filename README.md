...
You can install the Xenon View SDK from [maven central](https://search.maven.org/artifact/io.github.xenonview-com/xenon-view-sdk/0.1.5/jar):
...
Via gradle (groovy):
```groovy
implementation "io.github.xenonview-com:xenon-view-sdk:0.1.5"
```
...
[Download Jar](https://s01.oss.sonatype.org/content/repositories/releases/io/github/xenonview-com/xenon-view-sdk/0.1.5/xenon-view-sdk-0.1.5.jar)  
[Download Dependencies Jar](https://github.com/xenonview-com/view-java-sdk/releases/download/v0.1.5/xenon-view-sdk-0.1.5-dependencies.jar)
