...
You can install the Xenon View SDK from [maven central](https://search.maven.org/artifact/io.github.xenonview-com/xenon-xenon-sdk/0.0.5/jar):
...
Via gradle (groovy):
```groovy
implementation 'io.github.xenonview-com:xenon-xenon-sdk:0.0.5'
```
